...
<li><a href="#"><i class="fa fa-smile-o"></i><span><fmt:message key="questionnaire.questionnaire" /></span></a>
	<ul class="sub-menu">
		...
		<li class="<%=JspUtil.isActive(request, "questionnaireType")%>"><a href="/questionnaire/questionnaireType/home"><fmt:message
					key="questionnaire.questionnaireType.manager"></fmt:message></a></li>
