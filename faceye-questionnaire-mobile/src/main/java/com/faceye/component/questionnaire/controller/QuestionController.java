...
public class QuestionController extends BaseController<Question, Long, QuestionService> {
	 ...
	 */
	@RequestMapping("/save")
	public String save(@Valid Question question,BindingResult bindingResult, RedirectAttributes redirectAttributes,Model model,HttpServletRequest request) {
		if(bindingResult.hasErrors()){
			beforeInput(model,request);
			return "questionnaire.question.update";
		}else{
		   this.beforeSave(question,request);
		   this.service.save(question);
		   return "redirect:/questionnaire/question/home";
		}
	}
