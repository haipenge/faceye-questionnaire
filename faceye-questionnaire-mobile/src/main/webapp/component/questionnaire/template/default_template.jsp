...
<body>
	<nav class="navbar navbar-light navbar-fixed-top bg-faded m-a-0" style="background-color: #e3f2fd; padding: 2px 2px 2px 2px; height: 36px">
		<tiles:insertAttribute name="default-header"></tiles:insertAttribute>
	</nav>
	<div class="container-fluid m-t-0" style="margin-bottom: 40px;">
